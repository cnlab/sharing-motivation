---
title: "Supplementary analyses: Study 3"
author: "Dani Cosme"
date: "`r Sys.Date()`"
output:
  html_document:
...
Given the high correlation between the preregistered Neurosynth ROIs, we article_conducted sensitivity analyses using ROIs from [Scholz et al. (2017) A neural model of valuation and information virality](https://www.pnas.org/doi/10.1073/pnas.1615259114).
