...
```{r}
library(pacman)
pacman::p_load(tidyverse, purrr, fs, knitr, lmerTest, ggeffects, kableExtra, boot, install = TRUE)
```
...
`r emo::ji("x")`  H2a: Focus-on-self intervention (compared to control) will increase self-relevance
...
`r emo::ji("x")` H2b: Focus-on-other intervention (compared to control) will increase social relevance
...
[Link to the preregistration](https://docs.google.com/document/d/1IFH5RquBgtJF-xYiBDYgLO7YF0D59DkENDHC9b00QQk/edit)
...
### self-referential ROI {.tabset}
`r emo::ji("check")` H4a: Focus-on-self intervention (compared to control) will increase brain activity in ROIs related to self-referential processes.
...
`r emo::ji("check")``r emo::ji("x")` H4b: Focus-on-other intervention (compared to control) will increase brain activity in ROIs related to mentalizing processes.
...
`r emo::ji("x")` H5a: Focus-on-self intervention (compared to control) will increase sharing intentions

`r emo::ji("x")` H5b: Focus-on-other intervention (compared to control) will increase sharing intentions
...
`r emo::ji("check")` H7a: The effect of focus-on-self intervention on sharing intention is mediated by increased activity in the self-referential ROI.
...
`r emo::ji("x")` H7b: The effect of focus-on-other intervention on sharing intention is mediated by increased activity in the mentalizing ROI.
