...
post = read.csv("~/Documents/code/cnlab/bbprime/bbprime_neuro/data/task_postscanner.csv", stringsAsFactors = FALSE) %>%
...
events = fs::dir_ls("~/Documents/code/cnlab/bbprime/bbprime_neuro/data/events/", regexp = ".*share.*tsv", recurse = TRUE) %>%
  map_dfr(read_events) %>%
...
betas = fs::dir_ls("~/Documents/code/cnlab/bbprime/bbprime_neuro/data/task-share_model-beta/", regexp = ".*csv") %>%
  map_dfr(read_betas) %>%
